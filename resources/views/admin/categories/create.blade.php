...
@section('title', 'Liberato · Criar Categoria')
...
<div class="admin-shell">
    ...
    <div style="margin: 2rem 0;">
        <h2 style="font-size: 2.5rem; font-weight: 700; color: #ffffff; margin-bottom: 0.5rem;">Criar Nova Categoria</h2>
        <p style="color: #9ca3af; font-size: 1.5rem;">Adicionar nova categoria de livros</p>
    </div>
