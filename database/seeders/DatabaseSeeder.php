...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // DISABLED: This seeder was executing thingy-seed.sql which conflicts with liberato_db
        // Database schema should be loaded manually from database-sql/liberato.sql
        // and data from database-sql/populate.sql
