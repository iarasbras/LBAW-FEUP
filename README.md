...
https://gitlab.up.pt/lbaw/lbaw2526/lbaw25134

> Full Docker command to launch the image available in the group's GitLab Container Registry using the production database:    
`docker run -d --name lbaw25134 -p 8001:80 gitlab.up.pt:5050/lbaw/lbaw2526/lbaw25134`

### 2. Usage

#### 2.1. Administration Credentials

> Administration URL: [\<URL\>](http://localhost:8001/admin/dashboard)

| Email | Password |
|----------|----------|
| admin1@liberato.com | password |
...
| seller | carlos@example.com | password |
